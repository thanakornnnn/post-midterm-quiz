...
my_DB = DB()
my_DB.insert(movies_table)

my_movies_table = my_DB.search("Movies")
my_movies_table_filter_comedy = movies_table.filter(lambda x: x["Genre"] == "Comedy")
my_movies_table_filter_fantasy = movies_table.filter(lambda x: x["Genre"] == "Fantasy")
print(len(my_movies_table_filter_fantasy.table))
dict = {}
...
# movies_table.insert_row()
# my_movies_table_filter_fantasy = movies_table.filter(lambda x: x["Genre"] == "Fantasy")
# print(my_movies_table_filter_fantasy.aggregate(lambda x: len(x)))
print(my_movies_table_filter_comedy.aggregate(lambda x: sum(x) / len(x), "Worldwide Gross"))

my_movies_table_filter_drama = movies_table.filter(lambda x: x["Genre"] == "Drama")
print(my_movies_table_filter_drama.aggregate(lambda x: min(x), "Audience score %"))